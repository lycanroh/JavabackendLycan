package com.kidzo.auth.Security;
...
import com.kidzo.auth.exception.AuthAPIException;
...
public class JwtTokenProvider {
    ...
    public boolean validateToken(String token){
        try{
            ...
            throw new AuthAPIException(HttpStatus.BAD_REQUEST, "Invalid JWT signature");
